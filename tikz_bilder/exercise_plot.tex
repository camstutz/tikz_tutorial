\begin{tikzpicture}[domain=0.2:6]
  ...
  \draw plot[only marks, mark=x, mark options={blue, thick}] file {working_material/measurement.dat};
  \draw[color=green] plot[smooth] (\x, {1+pow((1/3)*\x, 2)}) node[right] {$f(x) = 1+\frac{1}{3}x^{2}$};
